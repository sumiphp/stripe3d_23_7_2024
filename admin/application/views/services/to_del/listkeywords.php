                                    ...
                                    <div class="col-lg-12 col-md-12">
                                        <div class="inner-card">
                                            <div class="inner-card-body">
                                              ...
                                              <span id="msg"></span><?php echo $this->session->flashdata('flash_msg1');?> <?php echo $this->session->flashdata('flash_msg1');?><br>
                                                <div id="data-source-1_wrapper" class="dataTables_wrapper">
                                                  ...
                                                  <tr role="row" class="odd" id="<?php echo $res['keywordid'];?>" >
                                                      ...
                                                      <td> 
                                                        <ul class="action"> 
                                                          <li class="edit"> <a href="<?php echo base_url().'Welcome/editkeywords/'.$res['keywordid'];?>" data-bs-original-title="" title=""><i class='bx bx-edit'></i></a></li>
                                                          <li class="delete"><a href="#" onclick="delrow(<?php echo $res['keywordid'];?>)" data-bs-original-title="" title=""><i class='bx bx-trash'></i></a></li>
