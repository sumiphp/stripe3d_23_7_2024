            ...
            <div class="row">
                <div class="col-md-6 col-lg-6">
                    <div class="subscribe-area">
                        <h2>News Letter</h2>
                        <p><?php //echo $newsletter->newsletterdescription;?>
                    
                        Join our newsletter to stay in the loop about the latest trends in digital marketing, branding, and business growth. Receive exclusive insights, tips, and offers directly to your inbox. Take advantage of the opportunity to elevate your online presence and unlock new possibilities for your brand. Sign up today and be a part of the Mosque community 
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer-single">
                        <div class="footer-single-content">
                            <a href="#">
                                <img src="<?php echo base_url().'uploads/logo/logo3.png'?>" width="100px" height="100px" alt="Logo">
                            </a>
                            <?php $this->db->select('*');
    ...
    ?>
                <div class="col-lg-4 col-md-6">
                    <div class="footer-list ml-50">
                      ...
                      <p>Our commitment to excellence has enabled us to establish a strong repu- tation in the industry, and our products are recognized for their unparalleled design and overall technical performance. At Mosque, we are dedicated to providing lighting solutions that are tailored to meet our clients’ specific needs and preferences, </p>
                    ...
                    <div class="footer-list ml-20">
                        ...
                        <ul>
                            <li>
                                ...
                                <?php //echo $contactus->city;?>94 Pier Avenue,Clacton-On_sea, CO15 1NJ<?php //echo $contactus->country;?>
                            </li>
                            <li>
                                <i class='bx bxs-phone'></i>
                                <a href="tel:+447974701829<?php //echo $contactus->phoneno;?>">+447974701829<?php //echo $contactus->phoneno;?></a>
                            </li>
                            <li>
                                <i class='bx bx-envelope'></i>
                                <a href="mailto:info@clactonmosque.com" <?php //echo $contactus->emailid;?>>info@clactonmosque.com <?php //echo $contactus->emailid;?></a>
                            </li>
