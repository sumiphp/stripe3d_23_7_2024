            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <a href="<?php echo base_url().'Welcome/dashboard';?>">
                            ...
                            <img src="<?php echo base_url().'uploads/logo/logo3.png'?>" width="100px" height="100px" class="modal-logo1" alt="<?php echo $siteinf->alttagimg1;?>">
                        </a>
                    </h2>
                </div>
                                            ...
                                            <div class="inner-card-body">
                                              ...
                                              <span id="msg"></span><br>
                                                <div id="data-source-1_wrapper" class="dataTables_wrapper">
                                                  ...
                                                  <tr role="row" class="odd" id="<?php echo $res['id'];?>" >
                                                      ...
                                                      <td> 
                                                        <ul class="action"> 
                                                          ...
                                                          <li class="delete"><a href="#" onclick="del(<?php echo $res['id'];?>)" data-bs-original-title="" title=""><i class='bx bx-trash'></i></a></li>
...
$.ajax({
            type: 'GET',
            url: "<?php echo base_url().'index.php/Welcome/deletepayments';?>",
            data:{id:id},
