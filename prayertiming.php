    ...
    class I18N_Arabic_Salat
    {
        ...
        /**
         * ÙØ±Ù‚ Ø§Ù„ØªÙˆÙ‚ÙŠØª Ø§Ù„Ø¹Ø§Ù„Ù…Ù‰
         * @ignore
         */
        protected $zone = 2;
        
        /**
         * Ø®Ø· Ø§Ù„Ø·ÙˆÙ„ Ø§Ù„Ø¬ØºØ±Ø§ÙÙ‰ Ù„Ù„Ù…ÙƒØ§Ù†
         * @ignore
         */
        ...
        /**
         * Ø§Ù„Ø§Ø±ØªÙØ§Ø¹ Ø¹Ù† Ø³Ø·Ø­ Ø§Ù„Ø¨Ø­Ø±
         * @ignore
         */
        protected $elevation = 0;
        
        /**
         * Ø²Ø§ÙˆÙŠØ© Ø§Ù„Ø´Ø±ÙˆÙ‚ ÙˆØ§Ù„ØºØ±ÙˆØ¨
         * @ignore
         */
         ...
         *                 
         * - Ø­Ø²Ø¨ Ø§Ù„Ø¹Ù„Ù…Ø§Ø¡ ÙÙŠ Ù„Ù†Ø¯Ù† Ù„Ø¯ÙˆÙ„
         * Ø£ÙˆØ±ÙˆØ¨Ø§ ÙÙŠ Ø®Ø·ÙˆØ· Ø¹Ø±Ø¶ ØªØ²ÙŠØ¯ Ø¹Ù„Ù‰ 48
         *       
         *      $ishaArc = -17
         *      $fajrArc = -17
         *      
