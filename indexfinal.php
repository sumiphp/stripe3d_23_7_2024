                                    ...
                                    <div class="d-inline-block form-sec">
                                        <form class="checkout-form w-100"  action="charge.php" method="post" id="payment-form">
                                            ...
                                            <div class="d-flex w-100">
                                                ...
                                                <input class="" type="text" id="customamount"  Placeholder='Custom amount'  class='txt' />
                                ...
                                <div class="footer-form">
                                    <form class="checkout-form w-100"  action="charge1.php" method="post" id="payment-form1">
                                        ...
                                        <div class="d-flex w-100">
                                            ...
                                            <input  type="text" id="customamount1"  Placeholder='Custom amount'  class='txt' >
                                        </div>
                                        <div class="amount-area d-flex">
                                            <div class="input-icon">
                                                <i>£</i>
                                        ...
                                        <ul class="method-list mb-0 list-unstyled w-100 d-flex">
                                            ...
                                            <li><input type="radio" name="method" id="radio22"> <label for="radio22"><img src="assets/images/images/visa-card.png"/></label></li>
                                                    ...
                                                    <div class='my-input' id="card-element1"></div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form class="row" method="post" id="frmcontact"  action="<?php //echo base_url().'Pocket/contactenquiryprocesspopup';?>">
                <div class="row">
                    <div class="col-md-6">
                        <div class="input-group">
                            ...
                            <input type="text" id="name" name="name" class="form-control txt" placeholder="FIRST NAME" aria-label="Username" aria-describedby="basic-addon1" >
                                        <label id="name-error" class="error errpopup" for="name" style='padding-top:0px'></label>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="input-group">
                        <input type="text" id="companyname" name="companyname" class="form-control txt" placeholder="LAST Name" aria-label="Username" aria-describedby="basic-addon1">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="input-group">
                        <input type="email" id="email1" name="email" class="form-control txt" placeholder="Email" aria-label="Username" aria-describedby="basic-addon1" >
                                        <label id="email-error" class="error errpopup" for="email" style='padding-bottom:0px'></label>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="input-group">
                        <input type="text" id="phone"  maxlength="12" name="phone" class="form-control phone txt" placeholder="Phone" aria-label="Username" aria-describedby="basic-addon1" >
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-primary" style="background-color: #009b0a;
