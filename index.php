                                        ...
                                        <form class="checkout-form w-100"  action="charge.php" method="post" id="payment-form">
                                            ...
                                            <div class="amount-area d-flex">
                                                <div class="input-icon">
                                                    <i>£</i>
                                                    <input type="text" id="myNumber" value="5" class='txt' readonly>
                                                  </div>

                                                  <div class="input-icon">
                                                    <i>£</i>
                                                    <input type="text" id="myNumber" value="10" class='txt' readonly>
                                                  </div>

                                                  <div class="input-icon">
                                                    <i>£</i>
                                                    <input type="text" id="myNumber" value="12" class='txt' readonly>
                                                  </div>

                                                  <div class="input-icon">
                                                    <i>£</i>
                                                    <input type="text" id="myNumber" value="25" class='txt' readonly>
                                                  </div>
                                ...
                                <div class="footer-form">
                                    <form class="checkout-form w-100"  action="charge1.php" method="post" id="payment-form1">
                                        ...
                                        <div class="amount-area d-flex">
                                            <div class="input-icon">
                                                <i>£</i>
                                                <input type="text" id="myNumber" value="5" class='txt1' readonly>
                                              </div>

                                              <div class="input-icon">
                                                <i>£</i>
                                                <input type="text" id="myNumber" value="10" class='txt1' readonly>
                                              </div>

                                              <div class="input-icon">
                                                <i>£</i>
                                                <input type="text" id="myNumber" value="12" class='txt1' readonly>
                                              </div>

                                              <div class="input-icon">
                                                <i>£</i>
                                                <input type="text" id="myNumber" value="25" class='txt1' readonly>
                                              </div>
                                ...
                                <div class="col-md-12 col-sm-12 col-lg-9">
                                    <div class="row justify-content-between">
                                                ...
                                                <div class="col-md-4 col-sm-6 col-lg-4 address-block">
                                                    ...
                                                    <ul class="mb-0 list-unstyled w-100">
                                                    <li><a href="https://maps.app.goo.gl/vK9zgJyDnUYjo6x87" target=_blank> 94 Pier Avenue, Clacton-On_sea, 
CO15 1NJ</a> </li>                              </li>
                                                    ...
                                                    <ul class="mb-0 list-unstyled w-100">
                                                    <li><a href="mailto:info@clactonmosque.com">info@clactonmosque.com </a> </li>                                 </li>
                                                    </ul>
                        ...
                        <div class="copyright-wrap">
                            ...
                            <p class="copyright-text">Copyright @ 2024 <a href="index.php">Clacton Mosque</a>. All Rights Reserved . Created with <img src="assets/images/images/heart.png"> by <a href="https://nexoro.co.uk/" target="_blank">NEXORO.</a></p>
                            </div>
