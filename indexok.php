        ...
        <main>
            ...
            <header class="stick style2 w-100">
                ...
                <div class="logo-menu-wrap v2 d-flex flex-wrap align-items-center justify-content-between pat-bg thm-layer opc65 back-blend-multiply thm-bg">
                    <div class="logo"><h1 class="mb-0"><a href="index.html" title="Home"><img class="img-fluid" src="assets/images/logo3.png" alt="Logo" ></a></h1></div><!-- Logo -->
                 
                  
                    <div class="right-callender d-flex text-right">
                        <div class="main-date text-right">
                            <div class="post-date2">
                                <span class="d-block">16 Dec </span>
                    ...
                    <div class="post-date-details">
                        <div class="Calendar-area">
                            <ul>
                                <li class="text-green "><i class='far fa-calendar'></i> FULL TIMETABLE & CALANDEE</li>
                    ...
                    <nav class="d-flex flex-wrap align-items-center justify-content-between">
                        <div >
                            <ul class="mb-0 list-unstyled d-inline-flex">
                                ...
                                <li ><a href="javascript:void(0);" title="">About</a>
                                   
                                </li>
                                <li ><a href="javascript:void(0);" title="">News & Event</a> </li>

                                <li><a href="javascript:void(0);" title="">Articles</a>  </li>
                                  
                                <li ><a href="javascript:void(0);" title="">Madrasah</a>   </li>
        
                                <li><a href="javascript:void(0);" title="">Service</a>  </li>
                        ...
                        <div class="header-right">
                            <a class="thm-btn bg-color1" href="javascript:void(0);" title="">Make Donation<span></span><span></span><span></span><span></span></a>

                            <a class="thm-btn second-bg" href="javascript:void(0);" title="">Contact Us<span></span><span></span><span></span><span></span></a>
                        </div>
                    </nav>
                </div>
            ...
            <section>
                <div class="w-100 position-relative">
                    ...
                    <div class="feat-wrap v2 position-relative w-100">
                        ...
                        <div class="feat-caro">
                        <div class='text-center'>   <?php if ( isset($_SESSION['payment_id']) ) { ?>
    <div class="success">
...
<?php } ?></div>
                                    ...
                                    <div class="d-inline-block form-sec">
                                        ...
                                        <form class="checkout-form w-100" action="charge.php" method="post" id="payment-form">
                                            ...
                                            <div class="row mt-20">
                                                <!--div class="col-12">
                                                    <div class="form__div ">
                                                        <input type="text" class="form-control" placeholder="Card Number " name="card_number" id="card_number" placeholder="1234 1234 1234 1234" maxlength="16" minlength="16">
                                                ...
                                                <div class="col-4">
                                                    <div class="form__div">
                                                        <input type="text" class="form-control" placeholder="Expiry Month " name="card_exp_month" id="card_exp_month" placeholder="MM" maxlength="2" minlength="2">
                                                ...
                                                <div class="col-4">
                                                    <div class="form__div">
                                                        <input type="text" class="form-control" placeholder="Expiry Year" name="card_exp_year" id="card_exp_year" placeholder="YYYY" maxlength="4" maxlength="4">
                                                ...
                                                <div class="col-4">
                                                    <div class="form__div">
                                                        <input type="text" class="form-control" placeholder="CVC" name="card_cvc" id="card_cvc" placeholder="CVC" maxlength="3" minlength="3">
        ...
        <!-- A Stripe Element will be inserted here. -->
                                            ...
                                            <div class="payment-method w-100">
                                                ...
                                                <button class="thm-btn thm-bg" type="submit" id="payBtn">Donate NOW<span></span><span></span><span></span><span></span></button>                                            
                                            </div>
                                            <div id='msg' class='text-center payment-status'></div>
                                        </form>
	                                 </div>
                                </div>
                            </div>
            ...
            <!-- About Area Wrap -->
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-6 col-lg-6  col-sm-12">
                                        <div class="about-inner4 w-100">
                                            ...
                                            <h2 class="mb-0" id='someSectionToJumpTo'>About Us</h2>
                ...
                <section>
                    <div class="w-100 ptb-80 position-relative">
                        <div class="container">
                                        ...
                                        <div class="time-inner w-100">
                                            ...
                                            <div class="time-list-wrap d-flex flex-wrap w-100">
                                                ...
                                                <div class="view-more mt-20 d-inline-block text-center w-100">
                                                    <a class="thm-btn thm-bg" href="#" title="">Enquiry Now<span></span><span></span><span></span><span></span></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div><!-- Time Wrap -->
                                            ...
                                            <div class="widget2 w-100">
                                                ...
                                                <div class="mini-posts-wrap w-100">
                                                    <div class="mini-post-box d-flex flex-wrap w-100">
                                                        <a href="#" title=""><img class="img-fluid w-100" src="assets/images/images/mini-post-3.png" alt="Mini Post Image 1"></a>
                                                    ...
                                                    <div class="mini-post-box d-flex flex-wrap w-100">
                                                        <a href="#" title=""><img class="img-fluid w-100" src="assets/images/images/mini-post-1.png" alt="Mini Post Image 3"></a>
                                                        <div class="mini-post-info">
            ...
            <section>
                <div class="w-100 ptb-80 position-relative form-footer-area">
                    <div class="container">
                        <div class="row">
 ...
 <form class="checkout-form w-100"  action="charge1.php" method="post" id="payment-form1">
                                        ...
                                        <div class="row mrg10">
                                            ...
                                            <div class="col-md-4 col-sm-4 col-lg-4">
                                                ...
                                                <div class="col-md-4 col-sm-4 col-lg-4">
                                                    <input type="tel" placeholder="Phone Number" name="phone1">
                                                </div>
                                        ...
                                        <ul class="method-list mb-0 list-unstyled w-100 d-flex">
                                            ...
                                            <li><input type="radio" name="method" id="radio22"> <label for="radio22"><img src="assets/images/images/visa-card.png"/></label></li>
                                                    ...
                                                    <!--div class="col-12">
                                                    <div class="form__div ">
                                                        <input type="text" class="form-control" placeholder="Card Number " name="card_number1" id="card_number1" placeholder="1234 1234 1234 1234" maxlength="16" minlength="16">
                                                ...
                                                <!--div class="col-4">
                                                    <div class="form__div">
                                                        <input type="text" class="form-control" placeholder="Expiry Month " name="card_exp_month1" id="card_exp_month1" placeholder="MM" maxlength="2" minlength="2">
                                                ...
                                                <div class="col-4">
                                                    <div class="form__div">
                                                        <input type="text" class="form-control" placeholder="Expiry Year" name="card_exp_year1" id="card_exp_year1" placeholder="YYYY" maxlength="4" maxlength="4">
                                                ...
                                                <div class="col-4">
                                                    <div class="form__div">
                                                        <input type="text" class="form-control" placeholder="CVC" name="card_cvc1" id="card_cvc1" placeholder="CVC" maxlength="3" minlength="3">
                                        ...
                                        <div class="payment-method w-100 mt-20">
                                            ...
                                            <button class="thm-btn thm-bg" type="submit"  id="payBtn1">Donate NOW<span></span><span></span><span></span><span></span></button>                                            
                                        </div>

                                        <div class="payment-status1" id="msg1" >  </div>
                                    </form>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-12">
                ...
                <div class="w-100 pt-70 dark-layer opc85 position-relative ">
                    ...
                    <div class="container">
                        ...
                        <div class="footer-data w-100">
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-lg-3">
                                    <div class="widget w-100">
                                        <div class="logo"><h1 class="mb-0"><a href="index.html" title="Home"><img class="img-fluid" src="assets/images/logo3.png" alt="Logo" srcset="assets/images/logo3.png"></a></h1></div>
                                                ...
                                                <div class="col-md-4 col-sm-6 col-lg-4">
                                                    <div class="widget w-100">
                                                        ...
                                                        <ul class="mb-0 list-unstyled w-100">
                                                            ...
                                                            <li><a href="#" title="">Our Events</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                                <div class="col-md-4 col-sm-6 col-lg-4">
                        ...
                        <div class="copyright-wrap">
                            ...
                            <p class="copyright-text">Copyright @ 2023 <a href="index.html">Clacton Mosque</a>. All Rights Reserved . Created with <img src="assets/images/images/heart.png"> by <a href="https://pocketfriendlyweb.com/" target="_blank">PocketFriendlyWeb.</a></p>
                            </div>
